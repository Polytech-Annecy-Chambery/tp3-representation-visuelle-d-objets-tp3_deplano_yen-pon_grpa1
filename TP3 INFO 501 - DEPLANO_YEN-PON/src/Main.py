...
def Q4a():
    ...
    wall1 = Wall({'position':[-3,1.2,0], 'width':7, 'height':2.6})
    wall2 = Wall({'position':[4,1.2,0], 'width':7, 'height':2.6,'orientation':90})
    wall3 = Wall({'position':[-3,8.2,0],'width':7, 'height':2.6, 'orientation':0})
    wall4 = Wall({'position':[-3,1.2,0],'width':7, 'height':2.6, 'orientation':90})  
